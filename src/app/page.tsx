  ...
  return (
    <div className="min-h-screen h-full flex flex-col justify-between">
      <header className="bg-gray-800 text-white p-6 w-full">
        <h1 className="text-4xl font-bold text-center">ホットペッパーグルメ検索</h1>
      </header>
      ...
      <footer className="bg-gray-800 text-white text-center p-4 w-full">
        Powered by <a href="http://webservice.recruit.co.jp/" className="text-purple-300 hover:underline">ホットペッパーグルメ Webサービス</a>
      </footer>
    </div>
  )
}
